...
"""
import sys, json, argparse  # grouped imports; no logging
from src.calc.stats import average, moving_average, stddev  # absolute import for demo

def main():
    parser = argparse.ArgumentParser(description="Compute simple statistics over a list of numbers.")
    parser.add_argument("--file", help="Path to JSON array file with numbers.")  # expects e.g. [1,2,3]
